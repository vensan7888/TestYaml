...
#     ex: sh smart-mock/scripts/deployMockFromRepo.sh https://github.com/username/yourProject.git master http://localhost:8080 y
#
#   To Clone Repo & 'Scan only' Yaml files since last commir, deploy contracts to mock server
#     ex: sh smart-mock/scripts/deployMockFromRepo.sh https://github.com/username/yourProject.git master http://localhost:8080
